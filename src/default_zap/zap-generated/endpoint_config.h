...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x00000000), 0x00000006, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* UserActiveModeTriggerHint */  \
...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x00000001, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MinMeasuredValue */  \
  { ZAP_EMPTY_DEFAULT(), 0x00000002, 2, ZAP_TYPE(TEMPERATURE), ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* MaxMeasuredValue */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 13, 96 }, \
  { ZAP_CLUSTER_INDEX(13), 3, 12 }, \
  { ZAP_CLUSTER_INDEX(16), 3, 12 }, \
...
#define FIXED_DEVICE_TYPES {{0x00000012,1},{0x00000016,4},{0x00000302,1},{0x00000307,1},{0x00000305,1}}
